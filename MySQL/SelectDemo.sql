...
-- Multi Level Sorting when 1st have many same entries for first level
...
SELECT OrderNumber,productCode,quantityOrdered*priceEach AS TotalPrice-- or  quantityOrdered*priceEach 'TotalPrice'
     FROM orderdetails
           ORDER BY quantityOrdered*priceEach desc;
